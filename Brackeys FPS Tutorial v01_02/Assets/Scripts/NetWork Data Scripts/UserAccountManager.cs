...
public class UserAccountManager : MonoBehaviour
{
    ...
    public string LoggedInSceneName = "Lobby";  //  This was added becuase I spotted in the vide.  Need to integrate
    public string LoggedOutSceneName = "LoginMenu";  //  This was added becuase I spotted in the vide.  Need to integrate
    ...
    public void GetData(OnDataReceivedCallback onDataReceived)
    {
        ...
        if (isLoggedIn && instance != null)
            StartCoroutine(GetData_numerator(playerUsername, playerPassword, onDataReceived));
    }

    IEnumerator GetData_numerator(string playerusername, string playerpassword, OnDataReceivedCallback onDataReceived)
    {
        string data = "ERROR";
